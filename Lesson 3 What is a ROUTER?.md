What is a router:- a device that connect different networks to each others it connect us to the internet

A switch can't recognize any ip address outside it's network
